...
<?php
  	...
  	mysqli_select_db($con,"library");
		...
		$sql = "SELECT r.RName, count(d.Doci_id) AS num FROM borrows b JOIN reader r ON b.Card_no = r.Card_no JOIN document d ON b.Doc_id = d.Doci_id JOIN book k ON b.Doc_id = k.Document_id JOIN branch h ON b.Lib_id = h.Lib_id AND h.Lib_name = '".$username."' GROUP BY r.RName ORDER BY num DESC LIMIT 10";
