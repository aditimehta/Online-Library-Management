...
<div id="container">
  ...
  <?php
  	...
  	mysqli_select_db($con,"library");
		$username=mysqli_real_escape_string($con,$_POST['PublisherName']);
		$sql = "SELECT Title, d.Doci_id, c.Copy_no, c.Lib_id
    FROM publisher p join document d 
    on d.Publisher_id=p.Pub_id  AND PName= '".$username."' 
    join copy c on d.Doci_id=c.Doc_id;";
