...
<div id="container">
  ...
  <?php
  	...
  	mysqli_select_db($con,"library");
		$username=mysqli_real_escape_string($con,$_POST['DocumentId']);
		$sql = "SELECT document.Title, document.Doci_id, copy.Copy_no, copy.Lib_id 
  FROM document join copy on document.Doci_id=copy.Doc_id WHERE document.Doci_id= '".$username."' ;";
